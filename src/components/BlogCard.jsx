...
const BlogCard = memo(({ blog }) => {
    ...
    const handleDownloadImage = async () => {
        ...
        try {
            ...
            cardClone.style.flex = '1'; // Fill remaining vertical space
            cardClone.style.display = 'flex';
            cardClone.style.flexDirection = 'column';
            cardClone.style.justifyContent = 'center'; // Center content vertically
            ...
            dateInfo.innerHTML = dayjs().format('MMMM D, YYYY');
